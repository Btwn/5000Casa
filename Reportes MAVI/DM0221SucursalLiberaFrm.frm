[Forma]
Clave=DM0221SucursalLiberaFrm
Nombre=DM0221 Sucursal Liberador
Icono=0
Modulos=(Todos)
...
ListaEnCaptura=Sucursal.Sucursal<BR>Sucursal.Nombre<BR>Sucursal.LiberaAut
CarpetaVisible=S
HojaTitulos=S
...
ColorFondo=Blanco
ColorFuente=Negro
[Sucursal.Sucursal.LiberaAut]
Carpeta=Sucursal
Clave=Sucursal.LiberaAut
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
