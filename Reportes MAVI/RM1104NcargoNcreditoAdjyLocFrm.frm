...
AccionesDerecha=S
ListaCarpetas=Var Tipo Rep<BR>Var Rep 1<BR>Var Rep 2
CarpetaPrincipal=Var Tipo Rep
PosicionInicialIzquierda=1895
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Filtros para Abonos a Cargos por Adj/Loc Generados  Manualmente                                                          .
Clave=Var Rep 1
AlineacionAutomatica=S
AcomodarTexto=S
MostrarConteoRegistros=S
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Filtros para Notas de Crédito Espejo y Posteriores Generados Automáticamente                                         .
Clave=Var Rep 2
AlineacionAutomatica=S
AcomodarTexto=S
MostrarConteoRegistros=S
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=Info.Ejercicio<BR>Info.MesSTMAVI
CarpetaVisible=S
