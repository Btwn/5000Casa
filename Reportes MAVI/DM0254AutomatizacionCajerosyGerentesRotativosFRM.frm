...
CarpetaVisible=S
ListaEnCaptura=Nombre<BR>Usr<BR>Sucursal
Filtros=S
FiltroPredefinido=S
...
Activo=S
Visible=S
Expresion=SI SQL(<T>Select dbo.fn_MaviDM0254ValidarCajas (:nsuc)<T> , Mavi.Sucursal) = 1<BR>    ENTONCES Precaucion(<T>Todas las cajas estan asignadas<T>)<BR>   SINO<BR>      Asigna(info.dialogo,  SQL(<T>EXEC dbo.SP_MAVIDM0254AutomatizacionCajerosyGerentesRotativos :tusu, :nsuc<T> , Mavi.DM0254Nomina, Mavi.Sucursal))<BR>          informacion(info.dialogo)<BR><BR>     FIN
