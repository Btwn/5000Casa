...
PosicionInicialAlturaCliente=960
PosicionInicialAncho=1280
VentanaTipoMarco=Normal
VentanaPosicionInicial=por Diseño
VentanaEstadoInicial=Normal
ListaAcciones=AbrirMovSC<BR>NuevoSC<BR>InfoCteSC<BR>CteCtoSC<BR>Coincidencias<BR>ServicasaUnicajaSC<BR>Calificacion<BR>Kardex<BR>MovPosSC<BR>MovBitacoraSC<BR>MovTiempoSC<BR>AgregarEventoSC<BR>RelacionCteSC<BR>HistoricoSolicitudes<BR>Registro<BR>RecomendadosServicasaSC<BR>ReporteServicasa<BR>NotasCobranza<BR>NotasAreaCobranza<BR>ServicredCred<BR>HistoricoUnicajaSC<BR>ExcelSC<BR>ActualizarSC<BR>PersonalizarSC<BR>Acercade<BR>Cerrar<BR>ReporteRM0855A<BR>ReporteServicred<BR>ReporteAnuelesSC<BR>Consulta
PosicionSec1=522
PosicionSec2=470
AccionesDivision=S
Comentarios=Usuario
...
BusquedaEnLinea=S
BusquedaAncho=25
ListaEnCaptura=SucursalOrigen<BR>Cliente<BR>Nombre<BR>CANALVENTA<BR>Condicion<BR>SolRefinanciamiento<BR>ImporteTotal<BR>TiempoTotalTranscurrido<BR>Estatus<BR>Situacion<BR>Reactivacion<BR>Grupo<BR>Relacionado<BR>Cita Supervisión<BR>%Supervision<BR>ReferenciaAnterior<BR>FechaAlta<BR>FF<BR>FUM<BR>Agente<BR>CategoriaVenta<BR>Seguimiento<BR>Calificacion<BR>Observaciones<BR>SucursalVenta<BR>SucursalDestino<BR>Fech. Alta. a Fech. Ult. Mod.<BR>Fech. Ult. Mod. a Fech. Act.
...
EjecucionCondicion=Asigna(Mavi.ServicasaConfigUsr1,SQL(<T>SELECT ACCESO FROM USUARIO WHERE USUARIO=:tval1<T>,Usuario))<BR>Asigna(Mavi.ServicasaGrupoCalif,(SQL(<T>EXEC SP_MAVIULTIMACALIFICACION :nval1,:tval2<T>,MaviServiCasaCredVis:Id,<T>Vtas<T>)))<BR>((MaviServiCasaCredVis:Estatus<>EstatusCancelado) y ((Mavi.ServicasaConfigUsr1=<T>CREDI_GERA<T>) o (Mavi.ServicasaConfigUsr1=<T>CREDI_USRA<T>) o (Mavi.ServicasaConfigUsr1=<T>COBMA_GERA<T>) o (Mavi.ServicasaConfigUsr1=<T>COBMA_USRA<T>)) o ((Mavi.ServicasaConfigUsr1=<T>VENTR_GERA<T>) y (Mavi.ServicasaGrupoCalif=<T>D<T>)) o ((Mavi.ServicasaConfigUsr1=<T>VENTP_GERA<T>) y (Mavi.ServicasaGrupoCalif=<T>C<T>)) o ((Mavi.ServicasaConfigUsr1=<T>VENTP_SUPA<T>) y (Mavi.ServicasaGrupoCalif=<T>C<T>)) o ((Mavi.ServicasaConfigUsr1=<T>VENTI_GERA<T>) y (Mavi.ServicasaGrupoCalif=<T<CONTINUA>
EjecucionCondicion002=<CONTINUA>>C<T>)) o ((Mavi.ServicasaConfigUsr1=<T>VENTC_GERA<T>) y (Mavi.ServicasaGrupoCalif=<T>C<T>)) o (Mavi.ServicasaConfigUsr1=<T>VENTC_USRA<T>) o (Mavi.ServicasaConfigUsr1 =<T>MAVI<T>) o (Mavi.ServicasaConfigUsr1 en (<T>COBMA_GERA<T>,<T>COBMA_USRA<T>))))
...
Activo=S
Visible=S
Expresion=Ejecutar(<T>\\172.16.202.2\Versiones\3100 Capacitacion\PlugIns\Inte601.exe <T>+MaviServiCasaCredVis:Cliente+<T> N<T>)
...
Activo=S
Visible=S
Expresion=Ejecutar(<T>C:\Archivos de programa\RF\Inte602.exe <T>+MaviServiCasaCredVis:Cliente+<T> N<T>)
