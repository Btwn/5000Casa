...
DECLARE
  ...
  BEGIN TRY
    ...
    SELECT @CB = CB FROM EmpresaCfg WHERE Empresa = @Empresa
    ...
    UPDATE @TablaInvD
      ...
      FROM @TablaInvD a
      JOIN InvD b
        ON (a.ID = b.ID AND a.Renglon = b.Renglon AND a.RenglonSub = b.RenglonSub AND a.RenglonID = b.RenglonID)
    ...
    ELSE
      BEGIN
        UPDATE @TablaInvD
          ...
          FROM @TablaInvD a
          JOIN ArtUnidad b
            ON (a.Articulo = b.Articulo AND a.Unidad = b.Unidad)
      END
